...
import (
	...
	scheme "github.com/cuisongliu/mysqlcontroller/pkg/client/clientset/versioned/scheme"
...
func newPodGroups(c *MysqlcontrollerV1Client, namespace string) *podGroups {
	return &podGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
