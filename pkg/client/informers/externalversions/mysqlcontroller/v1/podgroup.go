...
import (
	...
	versioned "github.com/cuisongliu/mysqlcontroller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/cuisongliu/mysqlcontroller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/cuisongliu/mysqlcontroller/pkg/client/listers/mysqlcontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MysqlcontrollerV1().PodGroups(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MysqlcontrollerV1().PodGroups(namespace).Watch(options)
			},
		},
		&mysqlcontrollerv1.PodGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysqlcontrollerv1.PodGroup{}, f.defaultInformer)
}
